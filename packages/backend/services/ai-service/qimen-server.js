...
2. 일본어 사용 금지 (は, を, の 등)
3. 아랍어, 기타 외국어 문자 사용 금지
4. <think> 태그나 사고 과정 노출 금지
5. 마크다운 형식(#, **, -) 사용 금지

✅ 반드시 지킬 사항:
1. 한글과 숫자, 문장부호 사용 (필요시 한자 병기 가능: "명궁(命宮)", "관록궁(官祿宮)")
2. 궁위 이름은 반드시 완전하게 표현: "명궁", "부부궁", "관록궁", "재백궁", "형제궁" 등
3. 친구에게 말하듯 편한 말투 (~거든요, ~해요, ~네요)
4. 궁위를 언급할 때는 "명궁이 강하고", "재백궁은 95점으로 높아" 처럼 명확히 표현
5. 절대 불완전한 문장 금지 (예: "에 이 있어" → "재백궁에 길성이 있어")

📋 궁위 표현 예시:
- 좋은 예: "관록궁이 57점으로 낮아 경쟁에서 어려움을 겪을 수 있어요"
- 나쁜 예: "관록운이 57점으로 낮아 에 이 있어" (불완전한 문장)

지금 바로 순수 한국어로 완전한 문장으로만 답변하세요.`,
        },
        {
          role: 'user',
          content: prompt,
