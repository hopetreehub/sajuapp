...
console.log('🧹 주흉 데이터베이스 정리 시작...');
db.serialize(() => {
    console.log('1. 기존 주흉 소분류 데이터 삭제 중...');
    // 기존 주흉 소분류 데이터 삭제
...
//# sourceMappingURL=clean-negative-database.js.map