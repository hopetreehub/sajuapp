...
export type QimenContext = 'general' | 'business' | 'love' | 'travel' | 'health' | 'wealth' | 'lawsuit' | 'education' | 'meeting' | 'study' | 'relationship' | 'decision';
...
export const CONTEXT_WEIGHTS: Record<QimenContext, ContextWeights> = {
  ...
  decision: {
    ...
    description: '결정, 선택, 판단, 의사결정',
    icon: '🎯',
    keywords: ['결정', '선택', '판단', '의사결정', '결심', '선택지'],
  },
};
